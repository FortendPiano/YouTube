...
bindSlideToggle('.hamburger', '[data-slide="nav"]', '.header__item', 'slide-active');
...
function load() {
    gapi.client.init({
        'apiKey': 'AIzaSyA8AG6TkNEl8eatBsxBR0R23NtGn3OOxhw',
...
//AIzaSyA8AG6TkNEl8eatBsxBR0R23NtGn3OOxhw Ключ API
